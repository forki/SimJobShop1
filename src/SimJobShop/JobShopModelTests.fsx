...
SelectedEntityFromWaitlist for the second entity is performed before
StartedProcess happened for the first entity:


Event '{Time = 30.05.2017 00:00:00;
...
Event '{Time = 30.05.2017 00:00:00;
 Fact = SelectedEntityFromWaitlist (Id 1UL,Id 1UL);}' generated 1 commands
Event '{Time = 30.05.2017 00:00:00;
 Fact = SelectedEntityFromWaitlist (Id 2UL,Id 1UL);}' generated 1 commands
Event '{Time = 30.05.2017 00:00:00;
 Fact = StartedProcess (Id 1UL,Id 1UL);}' generated 1 commands
System.Exception: Inconsistency => Not enough capacity available: location id = Id 1UL, capacity available = FiniteCapacity 0u, entity id = Id 2UL, capacity needed = FiniteCapacity 1u
